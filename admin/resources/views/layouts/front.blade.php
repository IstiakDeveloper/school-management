...
<body>
    ...
    <header class="bg-green-700 px-8 py-4 md:py-4 md:px-8">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <!-- Navigation -->
            <nav id="desktopNav" class="hidden md:flex items-center space-x-8">
                ...
                <!-- Login Button -->
                <a href="/login" class="text-white bg-green-900 hover:bg-green-500 rounded-md px-4 py-2 transition duration-300 ease-in-out">
                    Login
                </a>
            </nav>
        ...
        <div class="container mx-auto px-8 py-8 md:py-12 md:px-8">
            <div class="gap-4 md:grid grid-cols-4 py-12">
                <div class="flex md:grid flex-col items-center justify-center py-4 md:py-0">
                    ...
                    <p class="text-gray-800">Teaching children shapes their skills, curiosity, and discipline, guiding them toward successful futures.</p>
                    <div class="my-4 flex items-center">
                        ...
                        <h3 class="ml-4 text-xl text-gray-700"><a href="tel:+8801713758424">(+88) 01713 758424</a></h3>
                    </div>

                </div>

                <div class="">
                    <h3 class="text-2xl font-semibold">Classes</h3>
                ...
                <div class="">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-8 flex space-x-2">
                            ...
                            <a href="#" class="rounded-full border border-gray-500 p-2 bg-orange-500 hover:bg-orange-600 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-facebook text-black"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                            </a>
                        
                            <!-- Twitter icon with link -->
                            <a href="#" class="rounded-full border border-gray-500 p-2 bg-orange-500 hover:bg-orange-600 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-twitter text-black"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
                            </a>
                        
                            <!-- Instagram icon with link -->
                            <a href="#" class="rounded-full border border-gray-500 p-2 bg-orange-500 hover:bg-orange-600 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-instagram text-black"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                            </a>
                        
                            <!-- LinkedIn icon with link -->
                            <a href="#" class="rounded-full border border-gray-500 p-2 bg-orange-500 hover:bg-orange-600 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-linkedin text-black"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                            </a>
                        </div>                        
                    </div>
                </div>
            ...
            <section class="bg-green-700">
                <nav class="">
                    <div class="container mx-auto flex justify-between items-center  px-8 py-8 md:py-6 md:px-0">
                        <!-- Logo -->
