<div>
    <div class="shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 class="text-xl font-semibold mb-4">Create Student Admission</h2>
        <form wire:submit.prevent="submit" enctype="multipart/form-data">
            <div class="grid grid-cols-2 gap-6">
                <div>
                    <h2 class="text-lg font-semibold my-4 text-center p-4  border rounded-lg">Student Information</h2>
                    <div class="mb-4">
                        <label for="photo" class="block text-sm font-medium  ">1. Photo<span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="student_id" class="block text-sm font-medium  ">2. Student ID<span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="form_number" class="block text-sm font-medium  ">3. Form Number <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="school_class_id" class="block text-sm font-medium  ">4. School Class <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Branch -->
                    <div class="mb-4">
                        <label for="branch_id" class="block text-sm font-medium  ">5. Branch <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Name (Bangla) -->
                    <div class="mb-4">
                        <label for="name_bn" class="block text-sm font-medium  ">6. Name (Bangla) <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Name (English) -->
                    <div class="mb-4">
                        <label for="name_en" class="block text-sm font-medium  ">7. Name (English) <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="birth_certificate_number" class="block text-sm font-medium  ">8. Birth Certificate Number <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="birth_place_district" class="block text-sm font-medium  ">9. Birth Place District (According to birth certifiacate)</label>
                    ...
                    <!-- Date of Birth -->
                    <div class="mb-4">
                        <label for="date_of_birth" class="block text-sm font-medium  ">9. Date of Birth <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Gender -->
                    <div class="mb-4">
                        <label for="gender" class="block text-sm font-medium  ">10. Gender <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Nationality -->
                    <div class="mb-4">
                        <label for="nationality" class="block text-sm font-medium  ">11. Nationality <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Religion -->
                    <div class="mb-4">
                        <label for="religion" class="block text-sm font-medium  ">12. Religion <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Blood Group -->
                    <div class="mb-4">
                        <label for="blood_group" class="block text-sm font-medium  ">13. Blood Group</label>
                    ...
                    <!-- Class Role -->
                    <div class="mb-4">
                        <label for="class_role" class="block text-sm font-medium  ">14. Class Role <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Minorities -->
                    <div class="mb-4">
                        <span class="block text-sm font-medium  ">15. Minorities <span class="text-red-500 font-bold text-lg">*</span></span>
                        <div class="mt-1">
                    ...
                    @if($showMinorityName)
                        <!-- Minority Name -->
                        <div class="mb-4">
                            <label for="minority_name" class="block text-sm font-medium  ">15-1. Minority Name</label>
                    ...
                    <!-- Handicap -->
                    <div class="mb-4">
                        <label for="handicap" class="block text-sm font-medium  ">16. Handicap (If Handicap)</label>
                    ...
                    <h2 class="text-lg font-semibold my-4 text-center p-4  border rounded-lg">Parents Information</h2>

                    <hr class="w-full h-2">
                    <!-- Mother Information -->
                    <h4 class="font-bold mb-2">17. Mother Information (Acording to NID)</h4>
                    <div class="mb-4">
                        <label for="mother_nid" class="block text-sm font-medium  ">1. Mother NID / Birth Certificate</label>
                    ...
                    <div class="mb-4">
                        <label for="mother_dob" class="block text-sm font-medium  ">2. Mother Date of Birth</label>
                    ...
                    <div class="mb-4">
                        <label for="mother_name_bn" class="block text-sm font-medium  ">3. Mother Name (Bangla)</label>
                    ...
                    <div class="mb-4">
                        <label for="mother_name_en" class="block text-sm font-medium  ">4. Mother Name (English)</label>
                    ...
                    <div class="mb-4">
                        <label for="mother_mobile" class="block text-sm font-medium  ">5. Mother Mobile Number <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="mother_occupation" class="block text-sm font-medium  ">6. Mother Occupation</label>
                    ...
                    <div class="mb-4">
                        <label for="mother_dead" class="block text-sm font-medium  ">7. Mother Dead or Not <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="father_nid" class="block text-sm font-medium  ">1. Father NID / Birth Certificate</label>
                    ...
                    <div class="mb-4">
                        <label for="father_dob" class="block text-sm font-medium  ">2. Father Date of Birth</label>
                    ...
                    <div class="mb-4">
                        <label for="father_name_bn" class="block text-sm font-medium  ">3. Father Name (Bangla)</label>
                    ...
                    <div class="mb-4">
                        <label for="father_name_en" class="block text-sm font-medium  ">4. Father Name (English)</label>
                    ...
                    <div class="mb-4">
                        <label for="father_mobile" class="block text-sm font-medium  ">5. Father Mobile Number</label>
                    ...
                    <div class="mb-4">
                        <label for="father_occupation" class="block text-sm font-medium  ">6. Father Occupation</label>
                    ...
                    <div class="mb-4">
                        <label for="father_dead" class="block text-sm font-medium  ">7. Father Dead or Not <span class="text-red-500 font-bold text-lg">*</span></label>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label for="present_address_division" class="block text-sm font-medium  ">(i) Division <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_district" class="block text-sm font-medium  ">(ii) District <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_upazila" class="block text-sm font-medium  ">(iii) Upazila / Thana <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_city" class="block text-sm font-medium  ">(iv) City Corporation/ Pourosova/ Union/ Cantonment Board <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_ward" class="block text-sm font-medium  ">(v) Word Number <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_village" class="block text-sm font-medium  ">(vi) Village/ Moholla/ Road Name & Number</label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_house_number" class="block text-sm font-medium  ">(vii) House Holding Number</label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_post" class="block text-sm font-medium  ">(viii) Post</label>
                    ...
                    <div class="mb-4">
                        <label for="present_address_post_code" class="block text-sm font-medium  ">(ix) Post Code <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        ...
                        <label for="same_as_present" class="text-sm font-medium  ">Same as Present Address</label>
                    </div>

                    <!-- Permanent Address Division -->
                    <div class="mb-4">
                        <label for="permanent_address_division" class="block text-sm font-medium  ">(i) Division <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- District Selection -->
                    <div class="mb-4">
                        <label for="permanent_address_district" class="block text-sm font-medium  ">(ii) District <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Upazila Selection -->
                    <div class="mb-4">
                        <label for="permanent_address_upazila" class="block text-sm font-medium  ">(iii) Upazila / Thana <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_city" class="block text-sm font-medium  ">(iv) City Corporation/ Pourosova/ Union/ Cantonment Board <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_ward" class="block text-sm font-medium  ">(v) Word Number <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_village" class="block text-sm font-medium  ">(vi) Village/ Moholla/ Road Name & Number</label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_house_number" class="block text-sm font-medium  ">(vii) House Holding Number</label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_post" class="block text-sm font-medium  ">(viii) Post</label>
                    ...
                    <div class="mb-4">
                        <label for="permanent_address_post_code" class="block text-sm font-medium  ">(ix) Post Code <span class="text-red-500 font-bold text-lg">*</span></label>
                    ...
                    <!-- Guardian NID -->
                    <div class="mb-4">
                        <label for="guardian_nid" class="block text-sm font-medium  ">1. Guardian NID</label>
                    ...
                    <!-- Guardian DOB -->
                    <div class="mb-4">
                        <label for="guardian_dob" class="block text-sm font-medium  ">2. Guardian DOB</label>
                    ...
                    <div class="mb-4">
                        <label for="guardian_name_bn" class="block text-sm font-medium  ">3. Guardian Name (Bangla)</label>
                    ...
                    <div class="mb-4">
                        <label for="guardian_name_en" class="block text-sm font-medium  ">4. Guardian Name (English)</label>
                    ...
                    <!-- Guardian Mobile -->
                    <div class="mb-4">
                        <label for="guardian_mobile" class="block text-sm font-medium  ">5. Guardian Mobile</label>
                    ...
                    <div class="mb-4">
                        <label for="guardian_relationship" class="block text-sm font-medium  ">6. Guardian Relationship</label>
                    ...
                    <div class="mb-4 flex">
                        ...
                        <label for="information_correct" class="block text-sm font-medium  ">I agree that all information provided is correct. <span class="text-red-500 font-bold text-lg">*</span></label>
