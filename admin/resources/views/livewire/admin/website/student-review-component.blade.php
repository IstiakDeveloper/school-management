<div class="mx-auto p-8 rounded-lg shadow">
    ...
    <form wire:submit.prevent="storeReview" class="grid grid-cols-1 gap-6 md:grid-cols-2">
        <!-- Review Stars -->
        <div>
            <label for="review_stars" class="block text-sm font-medium ">Review Stars</label>
        ...
        <!-- Review Summary -->
        <div>
            <label for="review_summary" class="block text-sm font-medium ">Review Summary</label>
        ...
        <!-- Review Name -->
        <div>
            <label for="review_name" class="block text-sm font-medium ">Review Name</label>
        ...
        <ul>
            @foreach ($reviews as $review)
                <li class="flex items-center justify-between mb-4 p-4 border rounded-lg">
                    <div>
                        <p class="text-sm ">Stars: {{ $review['stars'] }} - Summary: {{ $review['summary'] }} - Name: {{ $review['name'] }}</p>
                    </div>
